...
namespace BethanyPieShop.Models
{
    public class AppDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        public DbSet<Pie> Pies { get; set; } //shows up in InitialMigration
        public DbSet<Category> Categories { get; set; } //shows up in InitialMigration
        public DbSet<ShoppingCartItem> ShoppingCartItems { get; set; }
        //then you would do a add-migration ShoppingCartItemAdded to keep up to date
        ...
        {
            //WE ADDED ALL OF THIS INFO IN OURSELVES BELOW 
